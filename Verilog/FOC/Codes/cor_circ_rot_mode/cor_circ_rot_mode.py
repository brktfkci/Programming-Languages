...
########################################################
##### xx initial = r         >>>  xn = rcos(theta) #####
##### yy initial = 0         >>>  yn = rsin(theta) #####
##### zz initial = theta     >>>  zn = 0           #####
########################################################
import math
...
xx = 1024
yy = 0
theta = -(math.pi / 3)    ## give radian value
...
def function_cordic (xx_cor, yy_cor, zz_cor, it_num_cor):
    ...
    y_val_list = [int(element / Ki) for element in yy_cor_list]
